    ...
    return (
      <div>
       ...
       <Navbar/>
        ...
        {/* <!-- Title page --> */}
        <section className="bg-img1 txt-center p-lr-15 p-tb-92 stylep1">
              ...
              <div className="col-11 col-md-5 col-lg-4 m-lr-auto">
                <div className="how-bor1 ">
                  <div className="hov-img0">
                    <img src={`${process.env.PUBLIC_URL}/project/themewagon.github.io/cozastore/images/about-01.jpg`} alt="IMG" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="row">
              ...
              <div className="order-md-1 col-11 col-md-5 col-lg-4 m-lr-auto p-b-30">
                <div className="how-bor2">
                  <div className="hov-img0">
                    <img src={`${process.env.PUBLIC_URL}/project/themewagon.github.io/cozastore/images/about-02.jpg`} alt="IMG" />
                  </div>
                </div>
              </div>
            </div>
