...
export default class Blog extends Component {
  render() {
				...
				<ul className="header-cart-wrapitem w-full">
					<li className="header-cart-item flex-w flex-t m-b-12">
						<div className="header-cart-item-img">
									<img src={`${process.env.PUBLIC_URL}/project/themewagon.github.io/cozastore/images/item-cart-01.jpg`} alt="IMG"/>
						</div>
					...
					<li className="header-cart-item flex-w flex-t m-b-12">
						<div className="header-cart-item-img">
									<img src={`${process.env.PUBLIC_URL}/project/themewagon.github.io/cozastore/images/item-cart-02.jpg`} alt="IMG"/>
						</div>
					...
					<li className="header-cart-item flex-w flex-t m-b-12">
						<div className="header-cart-item-img">
									<img src={`${process.env.PUBLIC_URL}/project/themewagon.github.io/cozastore/images/item-cart-03.jpg`} alt="IMG"/>
						</div>
	...
	{/* <!-- Title page --> */}
        <section className="bg-img1 txt-center p-lr-15 p-tb-92 styleb1"
					...
					<div className="p-r-45 p-r-0-lg">
						...
						<div className="p-b-63">
							<a href="blog-detail.html" className="hov-img0 how-pos5-parent">
										<img src={`${process.env.PUBLIC_URL}/project/themewagon.github.io/cozastore/images/blog-04.jpg`} alt="IMG-BLOG"/>
						...
						<div className="p-b-63">
							<a href="blog-detail.html" className="hov-img0 how-pos5-parent">
										<img src={`${process.env.PUBLIC_URL}/project/themewagon.github.io/cozastore/images/blog-05.jpg`} alt="IMG-BLOG"/>
						...
						<div className="p-b-63">
							<a href="blog-detail.html" className="hov-img0 how-pos5-parent">
										<img src={`${process.env.PUBLIC_URL}/project/themewagon.github.io/cozastore/images/blog-06.jpg`} alt="IMG-BLOG"/>
							...
							<ul>
								<li className="flex-w flex-t p-b-30">
									<a href="/" className="wrao-pic-w size-214 hov-ovelay1 m-r-20">
												<img src={`${process.env.PUBLIC_URL}/project/themewagon.github.io/cozastore/images/product-min-01.jpg`} alt="PRODUCT"/>
									</a>
								...
								<li className="flex-w flex-t p-b-30">
									<a href="/" className="wrao-pic-w size-214 hov-ovelay1 m-r-20">
												<img src={`${process.env.PUBLIC_URL}/project/themewagon.github.io/cozastore/images/product-min-02.jpg`} alt="PRODUCT"/>
									</a>
								...
								<li className="flex-w flex-t p-b-30">
									<a href="/" className="wrao-pic-w size-214 hov-ovelay1 m-r-20">
												<img src={`${process.env.PUBLIC_URL}/project/themewagon.github.io/cozastore/images/product-min-03.jpg`} alt="PRODUCT"/>
									</a>
